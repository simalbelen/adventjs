...
function contains(store, product){
    ...
    //Caso recursivo -> ejecuto la funcion con el array hijo
    keys = Object.keys(store)
    const value = keys.reduce(function(accum, key){
        return accum || contains(store[key], product)
    }, false);
